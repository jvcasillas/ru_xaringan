...
output:
  xaringan::moon_reader:
    lib_dir: libs
    css: ["default", "http://www.jvcasillas.com/ru_xaringan/css/ru_xaringan.css"]
    nature:
...
will make text <grey>grey</grey>, <black>black</black> and <RUred>red</RUred> <blue>blue</blue>
...
- We can center tables by surrounding them with .center[]
- This is not standard in xaringan, but is added in the <RUred>ru_xaringan</RUred> custom css

.center[

|  This |  is |  a   |     Table      |
| :---- | :-- | :--- | :------------: |
| It is | now | able | to be centered |
| 12    | 34  | 56   |       78       |
...
|                                                                                                                 |                                       |
| :-------------------------------------------------------------------------------------------------------------- | :------------------------------------ |
| <a href="mailto:joseph.casillas@rutgers.edu"><RUred><i class="fa fa-paper-plane fa-fw"></i></RUred>               | joseph.casillas@rutgers.edu</a>       |
| <a href="http://www.jvcasillas.com/ru_xaringan/slides/index.html"><RUred><i class="fa fa-link fa-fw"></i></RUred> | jvcasillas.com/ru_xaringan/slides</a> |
| <a href="http://twitter.com/jvcasill"><RUred><i class="fa fa-twitter fa-fw"></i></RUred>                          | @jvcasill</a>                         |
| <a href="http://github.com/jvcasillas"><RUred><i class="fa fa-github fa-fw"></i></RUred>                          | @jvcasillas</a>                       |
